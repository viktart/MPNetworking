...
open class NetworkManager {
    ...
    func composeRequest(relativeURLString: String, httpMethod: HttpMethod) throws -> Request {
    ...
    func composeRequest(absoluteURLString: String, httpMethod: HttpMethod) throws -> Request {
    ...
    func composeRequest(url: URL, httpMethod: HttpMethod) -> Request {
    ...
    func performDataRequest( request: Request, callback: @escaping (Data?,URLResponse?,Error?)->Void ) {
...
extension NetworkManager {
    ...
    func perform( request : Request, callback : @escaping (DataDictionary?, Error?) -> Void ) {
